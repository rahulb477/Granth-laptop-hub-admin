...
export default function FooterPagesCMS() {
  ...
  const [footer, setFooter] = useState({
    ...
    description: "Jodhpur's trusted laptop destination for certified refurbished & new laptops. Tested, certified, with full warranty assistance.",
    copyright: "© 2025 Granth Laptop Hub Jodhpur. All rights reserved.",
    links: [
