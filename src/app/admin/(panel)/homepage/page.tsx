...
export default function HomepageCMSPage() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await setDocData("homepage", "content", homepage);

      // Also if a spotlight product is selected, ensure that product has spotlight: true
      if (homepage.spotlightProductId) {
        ...
        if (targetProd && targetProd.id) {
          // Set target to spotlight: true, and unset others
