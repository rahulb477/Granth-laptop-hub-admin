...
const NAV: { label: string; href: string; icon: string; badge?: string }[] = [
  ...
  { label: "Enquiries (WhatsApp)", href: "/admin/enquiries", icon: "whatsapp" },
  { label: "Banner & Slider", href: "/admin/media", icon: "image" },
  { label: "Homepage CMS", href: "/admin/homepage", icon: "home" },
  { label: "Videos", href: "/admin/videos", icon: "play" },
  { label: "Pages", href: "/admin/footer", icon: "layout" },
  { label: "Blog", href: "/admin/blog", icon: "doc" },
  { label: "Offers & Coupons", href: "/admin/offers", icon: "percent" },
  { label: "Testimonials", href: "/admin/reviews", icon: "chat" },
  { label: "Appearance", href: "/admin/appearance", icon: "brush" },
  ...
  { label: "Backup & Export", href: "/admin/backup", icon: "download" },
  { label: "Activity Log", href: "/admin/activity", icon: "clock" },
  { label: "Website Connection", href: "/admin/connection", icon: "external" },
];
